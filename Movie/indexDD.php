		...
		<div class="row">
			...
			<div class="col-1-2">
				<div class="wrap-col f-right">
							...
							<form method="post" action="SearchDD.php" id="search"  >
								<input name="tim"  type="text" size="40" placeholder="Đạo diễn ..." />
		...
		<div id="main-content" class="col-2-3">
			<div class="wrap-content">
				<div class="movie">
					<div class="row type">
						<div class="title">
							<center><h2> ĐẠO DIỄN </h2></center>
						</div>
						
					</div>
					<?php					 require_once ('C:\xampp\htdocs\Movie\PhânTrangDD.php');?>
					</div>
