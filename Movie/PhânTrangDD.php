...
echo "<div>";
    ...
    // BU?C 6: HI?N TH? IDANH SÁCH TIN T?C
     require_once ('C:\xampp\htdocs\Movie\daodien.php') ;
...
<div class="pagination">
    ...
    if ($current_page > 1 && $total_page > 1){
        ...
        echo "<a href='indexDD.php?page='.($current_page-1).''style='color: white'>Prev</a> | ";
    }
    ...
    for ($i = 1; $i <= $total_page; $i++){
        ...
        if ($i == $current_page){
            ...
            echo '<a href="indexDD.php?page='.$i.'">'.$i.'</a> | ';
        }
    }
    // n?u current_page < $total_page và total_page > 1 m?i hi?n th? nút prev
    if ($current_page < $total_page && $total_page > 1){
        echo '<a href="indexDD.php?page='.($current_page+1).'">Next</a> | ';
    }
    ?>
</div>
</body>
