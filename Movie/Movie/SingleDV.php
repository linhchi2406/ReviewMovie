...
$id1 = $_GET['id'];
$sql1="select *from DienVien,Movie,DongPhim
where
DongPhim.IdDienVien=DienVien.IdDienVien
and DongPhim.IdMovie=Movie.IdMovie
and
DienVien.IdDienVien like '%$id1%'";
 $params = array();
        ...
        $row = sqlsrv_fetch_array($query1);
					...
					echo "<div class='art-header'>";
						...
						echo "<div class='col-2-3'>
							    <div class='wrap-col'>
								  <ul
									<li><p> Họ Tên : {$row['FullNameDV']}</a></p></li>
