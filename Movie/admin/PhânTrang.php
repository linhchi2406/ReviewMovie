...
echo "<div>";
    ...
    // BU?C 6: HI?N TH? IDANH SÁCH TIN T?C
     require_once ('C:\xampp\htdocs\Movie\admin\phim.php') ;
...
<div class="pagination">
    ...
    if ($current_page > 1 && $total_page > 1){
        ...
        echo "<a href='product_listing.php?page='.($current_page-1).''style='color: white'>Prev</a> | ";
    }
    ...
    if ($current_page < $total_page && $total_page > 1){
        echo '<a href="product_listing.php?page='.($current_page+1).'">Next</a> | ';
    }
    ?>
</div>
</body>
